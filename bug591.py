...
if __name__ == "__main__":
    ...
    filter_params = {
        ...
        'section':'209,208,207,210',
        # 'mrtline': '125',  # (位置2) 淡水信義線
        # 'mrtcoods': '4198,4163',  # (位置3) 新北投 & 淡水
        'kind': '1',  # (類型) 獨立套房
        # 'multiPrice': '10000_20000',  # (租金) 5000元以下 & 5000-10000元
        'rentprice': '10000,18000',  # (自訂租金範圍) 3000~6000元
    ...
    total_count, houses = house591_spider.search(filter_params, sort_params, want_page=4)
    print('搜尋結果房屋總數：', total_count)
    print(len(houses))
    # jsonstr = json.dumps(houses, ensure_ascii=False)
    with open('house.json', 'w', encoding='utf-8') as f:
        f.write(json.dumps(houses, ensure_ascii=False))
